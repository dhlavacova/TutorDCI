...
//export const updateTaskRequest = async (task) =>
  //axios.put(`/protocol/${task._id}`, task);

//export const deleteTaskRequest = async (id) => axios.delete(`/protocol/${id}`);

//export const getTaskRequest = async (id) => axios.get(`/protocol/${id}`);
