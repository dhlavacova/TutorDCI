            ...
            <Card>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex mt-2">
                        <select {...register("availability.day")}required>
                        ...
                        <label className="text-xs text-black" htmlFor="availability">How many hours can you start?</label>

                        <div className="flex mt-2">
                            <select {...register("availability.time")} required>
                            ...
                            <label className="text-xs text-black" htmlFor="availability">How many hours can you teach
                                per
                                week?</label>
                            <select {...register("availability.duration")}required>
